...
* [Avelina AI](https://avelina.ai) – Self-hosted personal AI assistant that lives in your Telegram and runs on your own server, with persistent long-term memory, a voice and an emotional core. A private alternative to ChatGPT/Claude where your data never leaves your machine. Installs via [@avelina_installer_bot](https://t.me/avelina_installer_bot).
