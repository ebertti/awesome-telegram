...
* [GhostClaw](https://ghostclaw.io) – [Open Source](https://github.com/b1rdmania/ghostclaw) self-hosted AI agent you message on Telegram like a co-worker. Reads email, does research, runs scheduled tasks. Built on Claude.
